                                 ...
                                 <script type="text/javascript">
                                    ...
                                    $(function() {
                                        $('#fromactualizar').submit(function() {
                                            ...
                                            $.get('<?php echo site_url('') ?>empleado/actualizar', data, function(respuesta) {
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="portlet box blue">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>EDITAR EMPRESA
                                                </div>
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <form id="fromactualizar"  class="form-horizontal">
                                                  <input type="hidden"  value="<?php echo $row->idempleado; ?>" maxlength="45" name="idEmpleado" />                                              
                                                  ...
                                                  <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control input-circle" maxlength="45" name="Nombre" value="<?php echo $row->Nombre; ?>" placeholder="Nombre" required="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control input-circle" value="<?php echo $row->apellidos; ?>" maxlength="45" name="apellidos" placeholder="Apellidos" required="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control input-circle" value="<?php echo $row->iniciales; ?>"  maxlength="45" name="iniciales" placeholder="INICIALES">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="email" class="form-control input-circle" value="<?php echo $row->email; ?>"  maxlength="45" name="email" placeholder="EMAIL">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="radio" name="pass" value="1"/> Restaurar 
                                                            <input type="radio" name="pass" value="0" checked=""/>Normal
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                            ...
                                                            <select class="form-control input-circle" required="" name="idempresa">
                                                                ...
                                                                if (isset($empresas)) {
                                                                    foreach ($empresas->result() as $rowx) {
                                                                        ...
                                                                        if ($row->idempresa == $rowx->idempresa) {
                                                                            ?>

                                                                            <option value="<?php echo $rowx->idempresa; ?>" selected=""><?php echo $rowx->nombre; ?></option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div id="colorSelector"><div style="background-color: <?php echo $row->color; ?>"></div></div>
                                                            <input type="hidden" id="colorNuevo" name="color" value="<?php echo $row->color; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($puestox)) {
                                                                foreach ($puestox->result() as $rowx) {
                                                                    ...
                                                                    if (in_array($rowx->idcat_puesto, $idpuestos)) {
                                                                        ?>

                                                                        <div class="checkbox-inline">
                                                                            <input type="checkbox" value="<?php echo $rowx->idcat_puesto; ?>" name="numero[]" checked=""> <?php echo $rowx->puesto; ?>
                                                                        </div>
