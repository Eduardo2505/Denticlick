...
<html lang="es">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Antecedentes Admin</title>
    ...
    <body class="login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" id="enviarbtn" action="<?php echo site_url('') ?>antecedentesadmin/login" method="POST">
...
<?php } ?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" maxlength="40" type="text" autocomplete="off" placeholder="Usuario" name="usuario" required="" />
                </div>
                <div class="form-group">
