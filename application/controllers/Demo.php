...
class Empresa extends CI_Controller {
    ...
    public function registro() {
        ...
        if (!empty($valorr)) {
            ...
            $valor = $this->models_empresa->insertar($data);
    ...
    public function mostrar() {
        ...
        $data['registros'] = $this->models_empresa->mostrar($nombre, $offset, $this->limite);

        $config['base_url'] = base_url() . 'empresa/mostrar?nombre=' . $nombre;
        $config['total_rows'] = $this->models_empresa->mostrarcount($nombre);
    ...
    public function actualizar() {
        ...
        $valor = $this->models_empresa->update($idregistro, $data);
    ...
    public function editar() {
        ...
        $data['menu'] = $this->load->view('plantilla/menu', $datax, true);
        $data['head'] = $this->load->view('plantilla/head', true);
        $data['query'] = $this->models_empresa->Buscar($idregistro);
